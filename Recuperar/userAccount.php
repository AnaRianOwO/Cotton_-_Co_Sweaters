...
if(isset($_POST['signupSubmit'])){
        ...
        if($_POST['password'] !== $_POST['confirm_password']){
            ...
            if($prevUser > 0){
                ...
                if($insert){
                    ...
                    $sessData['status']['msg'] = 'You have registered succesfully, log in with your credentials';
                }else{
                    $sessData['status']['type'] = 'error';
                    $sessData['status']['msg'] = 'Some problems ocurred, please try again';
                }
            }
        }
    }else{
    ...
    //redirect to the login details are empty
    ...
    if(!empty($_POST['email']) && !empty($_POST['password'])){
        ...
        if($userData){
            ...
            $sessData['status']['type'] = 'error';
            $sessData['status']['msg'] = 'Wrong emailor password, please try again';
        }
    }
}
