...
if(isset($_SESSION['idUsuario']) and isset($_SESSION['docType'])){
    ...
    $pro = mysqli_query($DB, "SELECT * FROM usuario U INNER JOIN factura F ON U.id_persona=F.id_persona INNER JOIN persona P ON P.id_persona=U.id_persona WHERE P.id_persona = '$idUsuario' AND P.docType = '$docType';");
}else{
