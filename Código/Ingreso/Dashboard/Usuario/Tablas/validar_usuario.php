<?php
  ...
  if(isset($_POST)){
    ...
    $consulta = "INSERT INTO usuario (idUsuario, docType, firstName, secondName, surname, secondSurname, indicativo, phone, correo, direccion, pass, idCiudad, idEstado)
    VALUES ('$idUsuario', '$docType','$firstName','$secondName', '$surname', '$secondSurname', '$indicativo', '$phone', '$correo', '$direccion', '$pass', '$idCiudad', '$idEstado' )";
